...
ControlDiv.append("div").style("position","absolute").style("width","100%").style("top","100px").style("left","0%").style("height","100%")
	.style("background-color","white").style("z-index",-1).style("border-radius","20px").style("border-style","solid").style("border-color","navy")
...
ControlG.append("circle").attr("r", 20).attr("cx",0).attr("cy",0).style("fill", "white")
...
ControlSvg.append("g").attr("transform", "translate(100,100)scale(3)rotate(90)")
